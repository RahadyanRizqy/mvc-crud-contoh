...
class Students {
    ...
    static function selectById($id) {} # Ditugaskan!
    
    static function selectWhere($clause) {} # Ditugaskan
    
    static function updateById($id, $name, $email, $role_fk) {} # Ditugaskan!
    
    static function updateWhere($clause) {} # Ditugaskan!
    
    static function deleteById($id) {} # Ditugaskan!
    
    static function deleteWhere($clause) {} # Ditugaskan!
}
